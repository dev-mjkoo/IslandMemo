...
class LocalizationManager {
    ...
    private let translations: [String: [String: String]] = [
        ...
        "링크를 복사하고 앱으로 돌아오세요": [
            "ko": "링크를 복사하고 앱으로 돌아오세요",
            "en": "Copy a link and return to the app",
            "ja": "リンクをコピーしてアプリに戻ってください",
            "zh": "复制链接后返回应用"
        ],
        "링크 저장 기능도 있어요!": [
            "ko": "링크 저장 기능도 있어요!",
        ...
        "개": [
            "ko": "개",
            "en": "items",  // 영어는 "items" 같은 단어를 별도로 처리
            "ja": "個",
            "zh": "个"
        ],
        "삭제": [
        ...
        "카테고리와 모든 링크가 삭제됩니다. 계속하시겠습니까?": [
            "ko": "카테고리와 모든 링크가 삭제됩니다. 계속하시겠습니까?",
            "en": "All links in this category will be deleted. Continue?",
            "ja": "カテゴリとすべてのリンクが削除されます。続行しますか？",
            "zh": "分类和所有链接将被删除。是否继续？"
        ],
        "새로운 카테고리 추가하기": [
            "ko": "새로운 카테고리 추가하기",
        ...
        "글래스 효과를 제대로 보려면 설정 → 손쉬운 사용 → 디스플레이 및 텍스트 크기 → 투명도 감소를 꺼주세요": [
            "ko": "글래스 효과를 제대로 보려면 설정 → 손쉬운 사용 → 디스플레이 및 텍스트 크기 → 투명도 감소를 꺼주세요",
            "en": "To see the glass effect properly, go to Settings → Accessibility → Display & Text Size → Turn off Reduce Transparency",
            "ja": "グラス効果を正しく表示するには、設定 → アクセシビリティ → 画面表示とテキストサイズ → 透明度を下げるをオフにしてください",
            "zh": "要正确查看玻璃效果，请前往设置 → 辅助功能 → 显示与文字大小 → 关闭降低透明度"
        ],
        "글래스 효과가 적용되지 않는다면,": [
            "ko": "글래스 효과가 적용되지 않는다면,",
            "en": "If glass effect doesn't work,",
            "ja": "グラス効果が適用されない場合、",
            "zh": "如果玻璃效果未生效，"
        ],
        "아이폰 설정에서": [
        ...
        "설정 → 손쉬운 사용 → 디스플레이 및 텍스트 크기": [
            "ko": "설정 → 손쉬운 사용 → 디스플레이 및 텍스트 크기",
            "en": "Settings → Accessibility → Display & Text Size",
            "ja": "設定 → アクセシビリティ → 画面表示とテキストサイズ",
            "zh": "设置 → 辅助功能 → 显示与文字大小"
        ]
    ]
